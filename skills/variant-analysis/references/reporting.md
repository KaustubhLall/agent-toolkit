...
Where the pattern can be encoded reliably, propose a regression test or CI rule. Do not invent a generic rule just to fill the template, and do not change CI unless implementation is in scope.
