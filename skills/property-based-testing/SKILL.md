...
metadata:
  upstream-effort: low
description: "Write, review, or debug property-based tests for input-domain invariants, parser and validator boundaries, serialization round trips, numeric rules, and state transitions. Use for constrained generators, independent oracles, or shrunk counterexamples. Not ordinary example tests, benchmarks, binary fuzzing, or UI end-to-end tests."
---
