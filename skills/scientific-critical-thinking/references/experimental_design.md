...
- [ ] **A priori power analysis conducted**
  ...
  - Desired power justified by effect size, design and decision costs
  - Significance/error criterion justified before seeing outcomes, including multiplicity
...
- [ ] **Primary analysis:**
  ...
  - Significance/error criterion prespecified and justified for this design
...
- [ ] No prospective power or precision rationale → adequacy is not established; this alone does not prove underpowering
