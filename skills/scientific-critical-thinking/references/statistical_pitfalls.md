...
- Justify prospective power or precision from the smallest important effect, design, multiplicity, and error costs; conventional percentages are examples, not automatic adequacy thresholds.
...
**Guidelines:**
- Evaluate the independent-unit count, dependence, sampling distribution, and precision; no universal n=30 threshold establishes adequacy.
